...
class fm12_obs(object):
  ...
  OBS_TYPES = {SYNOP: "SYNOP",
               SHIP: "SHIP",
               MOBILE_SYNOP: "MOBILE SYNOP"}

  WIND_TYPES = {WIND_TYPE_ESTIMATED_METER_PER_SECOND:"Estimated m/s",
...
class fm12_parser(object):
  ...
  SECTION1_PARTS={'1':_parse_section1_1,
                  '2':_parse_section1_2,
                  '3':_parse_section1_3,
                  '4':_parse_section1_4,
                  '5':_parse_section1_5,
  ...
  SECTION3_PARTS={'0':_parse_section3_0,
                  '1':_parse_section3_1,
                  '2':_parse_section3_2,
                  '3':_parse_section3_3,
                  '4':_parse_section3_4,
