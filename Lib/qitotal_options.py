...
'''
##
# Keeps information on the qitotal options,
# like site weight and what fields that are included in the qi-total algorithm.
#
...
CONFIG_FILE = os.path.join(
    os.path.join(os.path.split(os.path.split(os.path.abspath(__file__))[0])[0], 'config'), 'qitotal_options.xml'
)
...
class qitotal_site_information(object):
    ...
    def __init__(self, nod, qifields=None, weight=100.0):
