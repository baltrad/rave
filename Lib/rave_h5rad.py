...
# -*- coding: latin-1 -*-
#
# $Id: rave_h5rad.py,v 1.1.1.1 2006/07/14 11:31:54 dmichels Exp $
#
...
#
"""
rave_h5rad.py - Functions for initializing new RAVE objects, organized
                according to the H5rad information model.

The information model followed when representing data and products is that
developed in COST 717 for use with HDF5. References to the tables in the
information model specification are made throughout this module.

Michelson D.B., Holleman I., Hohti H., and Salomonsen M., 2002: HDF5
information model and implementation specification for weather radar data.
