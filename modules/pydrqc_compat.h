...
#ifndef PYDRQCCOMPAT_H
#define PYDRQCCOMPAT_H
...
#define PY_COMPARE_ATTRO_NAME_WITH_STRING(ptr, name) PyDRQCAPI_CompareWithASCIIString(ptr, name)

#define PY_COMPARE_STRING_WITH_ATTRO_NAME(name, ptr) PyDRQCAPI_CompareWithASCIIString(ptr, name)
 ...
 * @return 0, -1 or 1
 */
static int PyDRQCAPI_CompareWithASCIIString(PyObject* ptr, const char* name) {
  int result = -1;
