...
static double getarritem3d(int e,int x, int y, TrafoWrapper3D *tw)
{
  ...
  case 'L': /* PyArray_ULONG */  {
    unsigned long *a = (unsigned long *)tw->src[e]->data;
    ret = a[y*tw->inxsize+x];
    break;
  }
...
static void setarritem3d(int x, int y, double v, TrafoWrapper3D *tw)
{
  ...
  case 'L': /* PyArray_ULONG */  {
    unsigned long *a = (unsigned long *)tw->desta;
    int c = (unsigned long)v;
    if (v<0)  /* Oops: Not allowed!*/
      c=0;
    if (v>UINT_MAX)
      c=UINT_MAX;
...
static void settopoitem(int x, int y, double v, TrafoWrapper3D* tw)
{
  ...
  case 'L': /* PyArray_ULONG */  {
    unsigned long *a = (unsigned long *)tw->topodata;
    unsigned long c = (unsigned long)v;
    if (v<0)  /* Oops: Not allowed!*/
      c=0;
    if (v>ULONG_MAX)
      c=ULONG_MAX;
