...
class PyPolarScanTest(unittest.TestCase):
  ...
  def test_getAzimuthIndex_with_astart(self):
    ...
    #
    astart_test_list = [(359.9, 0.4, 0),   # Positive astart  -0.1 -> 0.9 with 1 degree ray width and astart 0.4
                        (359.8, 0.4, 359),
                        (358.9, 0.4, 358),
                        (0.91, 0.40, 1),
                        (0.89, 0.40, 0),
                        ...
                        (-0.1, 0.4, 0),
                        (-0.11, 0.4, 359),
                        (-0.4, -0.4, 0),   # Negative astart  -0.9 -> 0.1 with 1 degree ray width and astart -0.4
                        (0.1, -0.4, 0),
                        (0.11, -0.4, 1),
                        (359.8, -0.4, 0),
                        (359.1, -0.4, 0),
  ...
  def test_getAzimuthIndex_with_startazA_stopazA(self):
    ...
    dbzhParam.setData(numpy.zeros((360,1),numpy.int8))
    obj.addParameter(dbzhParam)
    startazA = numpy.arange(-0.9,359.1,1.0)
    startazA[0] = 359.1
    stopazA = numpy.arange(0.1,360.1,1.0)
